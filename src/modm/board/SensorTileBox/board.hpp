...
using LoggerDevice = modm::IODeviceWrapper< serial::Uart, modm::IOBuffer::BlockIfFull >;
...
initialize()
{
	...
	[[maybe_unused]] uint32_t tmpreg = RCC->APB1ENR1 & RCC_APB1ENR1_PWREN; // Delay after an RCC peripheral clock enabling

	// expansion of HAL_PWREx_EnableVddIO2()
	PWR->CR2 |= PWR_CR2_IOSV;

	serial::Uart::connect<serial::Tx::Tx, serial::Rx::Rx>();
	serial::Uart::initialize<SystemClock, 115200_Bd>();
